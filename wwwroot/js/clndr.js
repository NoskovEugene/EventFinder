  ...
  var clndrTemplate =
    "<div class='clndr-controls'>" +
        "<div class='clndr-control-button leftalign'>" +
            "<span class='clndr-previous-button' style = 'font-size: 18pt; font-weight: bold;'>&lsaquo;</span>" +
        '</div>' +
        "<div class='month'><%= month %> <%= year %></div>" +
        "<div class='clndr-control-button rightalign'>" +
            "<span class='clndr-next-button' style = 'font-size: 18pt; font-weight: bold;'>&rsaquo;</span>" +
        '</div>' +
    '</div>' +
